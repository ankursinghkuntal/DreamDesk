        ...
        <div className="flex gap-2 mb-6 mt-3">
          {isEdit || userData && userData.resume === "" ? (
            ...
            <div className="flex gap-2">
              {resume && (
                <a className="bg-blue-100 text-blue-600 px-4 py-2 rounded-lg" href={URL.createObjectURL(resume)} target="_blank" rel="noopener noreferrer">
                  View Resume
                </a>
              )}
        ...
        <table className="min-w-full bg-white border rounded-lg">
          <thead>
            <tr>
              ...
              <th className="py-3 px-4 border-b text-left max-md:hidden">Location</th>
              <th className="py-3 px-4 border-b text-left max-md:hidden">Date</th>
