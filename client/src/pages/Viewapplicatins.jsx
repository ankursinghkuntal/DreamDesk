                ...
                <tbody>
                    {viewApplicationsPageData.map((applicant,index)=>(
                        <tr key={index} className='text-gray-700'>
                            ...
                            <td className='py-2 px-4 border-b max-md:hidden'>{applicant.jobTitle}</td>
                            ...
                            <td className='py-2 px-4 border-b relative'>
                                <div className='relative inline-block text-left group'>
                                    ...
                                    <div className='z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shawdow group-hover:block'>
...
export default Viewapplicatins